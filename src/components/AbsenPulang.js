...
const AbsenPulang = ({userinfo_id}) => {
    ...
    useEffect(() => {
        ...
        pageTitle.innerText = 'Absen Pulang';
    }, [])
    ...
    const handleSubmit = async () => {
        ...
        const res = await axios.post('https://myapplaporankeeja.my.id/api/absen/pulang', data, {
            headers: {
...
export default connect(mapStateToProps)(AbsenPulang);
